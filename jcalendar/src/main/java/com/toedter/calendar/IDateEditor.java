...
public interface IDateEditor {
    ...
    /**
     * Sets the maximum selectable date. If the editor's current value is after
     * the maximum date then it is set to the given maximum.
     *
    ...
    /**
     * Sets the minimum selectable date. If the editor's current value is before
     * the minimum date then it is set to the given minimum.
     *
     ...
     * <code>null</code>.
     *
     * @param nullText the tet to be displayed
     */
    public void setNullText(String nullText);

    /**
     * Sets whether the text will be selected when the editor gains the focus.
     *
     * @param selectOnFocus whether the text will be selected when the editor
     * gains the focus
     */
